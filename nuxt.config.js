export default {
  ...
  head: {
    ...
    meta: [
      ...
      { hid: 'og:site_name', property: 'og:site_name', content: 'OMDb Movie Search'},
      { hid: 'og:title', property: 'og:title', content: 'OMDb Movie Search'},
      ...
      { hid: 'og:image', property: 'og:image', content: 'https://www.freepngimg.com/thumb/emoji/64910-whatsapp-bell-symbol-android-emoji-free-download-png-hq.png'},
